		...
		<form action="${pageContext.request.contextPath}/dmt1/create_acq_eib"
			...
			<table class="form-search-iss" style="width: 100%; margin-left: -5%;">
				...
				<tr>
					...
					<td><input type="file" name="acqPosEib_File"
						placeholder="Chứng từ đính kèm" class="form-control"
						style="width: 85%"></input></td>
				</tr>
				<tr>
					<td><select style="width: 85%" class="form-control"
						id="loaiThe" name="acqPosEib_NoiDungXuLy">
					...
					<td><div class="dropdown" style="width: 85%">
							...
							<ul name="acqPosEib_GDBatThuong"
								...
								<li><label> <input name="acqPosEib_GDBatThuong3"
										type="checkbox" value="acqPosEib_GDBatThuong3"> Giao dịch bất thường, MOTO
								</label></li>
					...
					<td><div class="dropdown" style="width: 85%">
							...
							<ul name="acqPosEib_YCXuatTrinhChungTu"
								...
								<li><label> <input
										...
										value="acqPosEib_YCXuatTrinhChungTu1"> Chủ thẻ yêu cầu chứng từ có chữ ký
								</label></li>
								<li><label> <input
								...
								<li><label> <input
										...
										value="acqPosEib_YCXuatTrinhChungTu3"> Chủ thẻ không đồng ý với số tiền trên hóa đơn
								</label></li>
								<li><label> <input
										name="acqPosEib_YCXuatTrinhChungTu4" type="checkbox"
										value="acqPosEib_YCXuatTrinhChungTu4"> Điều tra gian lận
								</label></li>
								<li><label> <input
				...
				<tr>
					<td colspan="3"><div class="form-group">
							...
							<textarea name="acqPosEib_tienDoXuLy"
